...
return [
    ...
    */
    'resources' => [
       ...
       // 'task-minimized' => \App\Models\Task::class,
        'task-intervent-types' => \App\Models\TaskInterventType::class,
        'boats' => \App\Models\Boat::class,
        'boat-users' => \App\Models\BoatUser::class,
        'project-users' => \App\Models\ProjectUser::class,
        'users' => \App\Models\User::class,
        'sections'=> \App\Models\Section::class,
        'updates' => \App\Models\Update::class,
        'comments' => \App\Models\Comment::class,
        'project-sections' => \App\Models\ProjectSection::class,
        'sites' => \App\Models\Site::class,
        'zones' => \App\Models\Zone::class,
        'histories' => \App\Models\History::class,
        'products' => \App\Models\Product::class,
        'project-products' => \App\Models\ProjectProduct::class,
        'tools' => \App\Models\Tool::class,
        'project-tools' => \App\Models\ProjectTool::class,
        'application-logs' => \App\Models\ApplicationLog::class,
        'report-items' => \App\Models\ReportItem::class,
        'suggestions' => \App\Models\Suggestion::class,
    ],
