...
//        return StormUtils::getAllBoatManagers();
    ...
    {
        return $this->getDocumentMediaFilePath(Document::ADDITIONAL_IMAGE_TYPE, 'thumb');
    }
    /**
     * Retrieve iamge's path
     *
    ...
    {
        return $this->getAllDocumentsMediaFilePathArray(Document::DETAILED_IMAGE_TYPE, 'thumb');
    }
